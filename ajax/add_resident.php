...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $db = new DbManager();
    $id = $db->execute(
          "INSERT INTO residents (full_name, relationship_id, birth_date, birth_place, civil_status_id, years_of_residency, occupation, citizenship, religion, gender_id, highest_education_attainment_id, deleted) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"
